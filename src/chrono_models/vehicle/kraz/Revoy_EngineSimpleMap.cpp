...
Revoy_EngineSimpleMap::Revoy_EngineSimpleMap(const std::string &name)
    : ChEngineSimpleMap(name) {}

double Revoy_EngineSimpleMap::GetMaxEngineSpeed() { return 2700 * rpm2rads; }

void Revoy_EngineSimpleMap::SetEngineTorqueMaps(ChFunctionInterp &map0,
                                                ChFunctionInterp &mapF) {
  ...
  // we provide some chip tuning to get 272 kW (370 HP) of the Kraz 64431 V8
  // Diesel
