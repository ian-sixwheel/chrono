...
const ChCoordsys<> Revoy_Chassis::m_driverCsys(ChVector3d(-1.5, 0.5, 1.2),
                                               ChQuaternion<>(1, 0, 0, 0));

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
Revoy_Chassis::Revoy_Chassis(const std::string &name,
  ...
  utils::ChBodyGeometry::BoxShape box1(ChVector3d(0.0, 0.0, 0.1),
                                       ChQuaternion<>(1, 0, 0, 0),
                                       ChVector3d(2.0, 1.0, 0.2));
  utils::ChBodyGeometry::BoxShape box2(ChVector3d(0.0, 0.0, 0.3),
                                       ChQuaternion<>(1, 0, 0, 0),
  ...
  m_geometry.vis_mesh_file =
      vehicle::GetDataFile("longhaul/meshes/SemiTractorBody.obj");
  ...
  case CollisionType::HULLS: {
    utils::ChBodyGeometry::ConvexHullsShape hull(
        vehicle::GetDataFile("longhaul/meshes/SemiTractorCab_col.obj"), 0);
  ...
  case CollisionType::MESH: {
    utils::ChBodyGeometry::TrimeshShape trimesh(
        ChVector3d(),
        vehicle::GetDataFile("longhaul/meshes/SemiTractorCab_col.obj"), 0.005,
        0);
